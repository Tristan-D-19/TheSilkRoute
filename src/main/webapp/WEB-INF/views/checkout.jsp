      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          ...
          for(OrderDetail item:cart){
              ...
              out.println("<div>");
                out.println("<h6 class='my-0'>"+item.getProduct().getProductName()+"</h6>");
                out.println("<small class='text-muted'></small>");
              out.println("</div>");
              out.println("<span class='text-muted'>"+item.getPrice()+"</span>");
            out.println("</li>");
          ...
          <form:form class="needs-validation" novalidate="">
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="firstName" placeholder="<% if(user!=null) out.print(user.getFirstName()); %>" value="" required>
