...
public interface OrderDetailDAOI {
	...
	enum SQL {
		CREATEORDERITEM("INSERT INTO TSR_ADMIN.TSR_ORDER_DETAILS (PRODUCT_ID, PRICE, QUANTITY) VALUES(?,?,?)"),
		GETALLORDERSBYID("SELECT * FROM TSR_ADMIN.TSR_ORDER_DETAILS WHERE ORDER_ID=?");
